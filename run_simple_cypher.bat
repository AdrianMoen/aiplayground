@echo off
echo Starting Simple Phi-3 Cypher Converter (Command Line)
echo ===============================================
echo.
...
echo Starting Simple Cypher REPL interface...
python simple_cypher_repl.py --adapter_path model_output\phi3-mini-cypher
